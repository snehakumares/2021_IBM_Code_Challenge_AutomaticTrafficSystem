...
Clone the repository using the CLI command 
```git clone https://github.com/snehakumares/2021_IBM_Code_Challenge_AutomaticTrafficSystem``` 
or downlaod the zip from the main page of repository and navigate into the root directory.
